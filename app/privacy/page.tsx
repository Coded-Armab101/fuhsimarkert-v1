  ...
  return (
    <main className="min-h-[100dvh] bg-white font-sans text-neutral-900">
      <div className="mx-auto max-w-xl px-6 py-14">
        ...
        <h1 className="mt-8 text-3xl font-black tracking-tight text-neutral-900">Privacy Policy</h1>
        <p className="mt-4 text-sm leading-relaxed text-neutral-500">
          Your privacy text goes here. This placeholder keeps the onboarding agreement links working until the full
          document is written.
        </p>
